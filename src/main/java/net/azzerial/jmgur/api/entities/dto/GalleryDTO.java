...
public interface GalleryDTO {
    ...
    @NotNull
    GalleryDTO setSection(@NotNull GallerySection section);

    @NotNull
    GalleryDTO setSort(@NotNull GallerySort sort);

    @NotNull
    GalleryDTO setTimeWindow(@NotNull GalleryTimeWindow timeWindow);

    @NotNull
    GalleryDTO showViral(boolean enabled);

    @NotNull
    GalleryDTO showNSFW(boolean enabled);

    @NotNull
    GalleryDTO includeImages(boolean enabled);
}
